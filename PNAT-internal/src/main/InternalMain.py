...
CLIENT_CERT_FILE = 'ssl/other/client/client.crt'
CLIENT_KEY_FILE = 'ssl/other/client/client.key'

HEARTBEAT_CA_FILE = 'ssl/heartbeat/ca/ca.crt'
HEARTBEAT_CLIENT_CERT_FILE = 'ssl/heartbeat/client/client.crt'
HEARTBEAT_CLIENT_KEY_FILE = 'ssl/heartbeat/client/client.key'
...
def InternalMain(remoteIP,commonPort,remotePort,localIp,localPort):
    ...
    context = ssl.SSLContext(ssl.PROTOCOL_TLS)
    context.check_hostname = False
    context.load_cert_chain(certfile=HEARTBEAT_CLIENT_CERT_FILE, keyfile=HEARTBEAT_CLIENT_KEY_FILE)
    context.load_verify_locations(HEARTBEAT_CA_FILE)
    context.verify_mode = ssl.CERT_REQUIRED
